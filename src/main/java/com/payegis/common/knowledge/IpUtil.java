...
public class IpUtil {
    ...
    private static final String IPADDRESS_PATTERN_STRING_V4 =
            "^([01]?\\d\\d?|2[0-4]\\d|25[0-5])\\." + "([01]?\\d\\d?|2[0-4]\\d|25[0-5])\\." +
                    "([01]?\\d\\d?|2[0-4]\\d|25[0-5])\\." + "([01]?\\d\\d?|2[0-4]\\d|25[0-5])$";

    private static final String IPADDRESS_PATTERN_STRING_V6 =
    ...
    private static final Pattern IPADDRESS_PATTERN_V4 = Pattern.compile(IPADDRESS_PATTERN_STRING_V4);
    private static final Pattern IPADDRESS_PATTERN_V6 = Pattern.compile(IPADDRESS_PATTERN_STRING_V6);

    public static boolean isIpFormat(String ip) {

        Matcher matcher = IPADDRESS_PATTERN_V4.matcher(ip);
        if (!matcher.matches()) {
            return isIpFormatV6(ip);
        }
        return matcher.matches();
    }

    public static boolean isIpFormatV6(String ip) {

        Matcher matcher = IPADDRESS_PATTERN_V6.matcher(ip);
        return matcher.matches();
    }
}
